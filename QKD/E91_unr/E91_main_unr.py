...
import E91_Alice_unr as E91_Alice_unr
import E91_Bob_unr as E91_Bob_unr
...
def run_E91_sim(runtimes=1,num_bits=20,fibreLen=10**-9,memNoiseMmodel=None,processorNoiseModel=None
    ...
    for i in range(runtimes): 
        ...
        Alice_protocol = E91_Alice_unr.AliceProtocol(nodeA,Alice_processor,num_bits,sourceFreq=sourceFreq)
        Bob_protocol = E91_Bob_unr.BobProtocol(nodeB,Bob_processor,num_bits)
        Bob_protocol.start()
...
if __name__ == "__main__":
    ...
    toWrite=run_E91_sim(runtimes=1,num_bits=10,fibreLen=5
    ...
    mylogger.info("key list A:{}\n".format(toWrite[0][0]))
    mylogger.info("key list B:{}\n".format(toWrite[1][0]))
