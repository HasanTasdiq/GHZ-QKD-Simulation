...
class BobProtocol(NodeProtocol):
    ...
    def run(self):
        ...
        print('basis for B ' , self.basisList)
        ...
        print('after measuring B\'s qubit ---- 1')
        ...
        print('measurement by B 1: ' , self.loc_measRes)
        ...
        # -------------------==========================-------------
        # self.myQG_B2_measure=QG_B_measure(
        #     basisList=self.basisList,num_bits=self.num_bits)
        # self.processor.execute_program(
        # self.myQG_B2_measure,qubit_mapping=[i for  i in range(0,self.num_bits)])
        
        # yield self.await_program(processor=self.processor)
     
        # for i in range(self.num_bits):
        #     tmp=self.myQG_B2_measure.output[str(i)][0]
        #     self.loc_measRes2.append(tmp)
        # print('measurement by B 2: ' , self.loc_measRes2)
        # self.loc_measRes2=Compare_basis(self.basisList,basis_A,self.loc_measRes2)
        # print('##Key B: ' , ''.join(map(str, self.loc_measRes2)))
        # -------------------==================================-------------
